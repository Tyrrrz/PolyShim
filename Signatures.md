...
- `BinaryPrimitives`
  ...
  - [`static bool TryReadDoubleLittleEndian(ReadOnlySpan<byte>, out double)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.tryreaddoublelittleendian) <sup><sub>.NET 5.0</sub></sup>
  ...
  - [`static bool TryReadSingleBigEndian(ReadOnlySpan<byte>, out float)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.tryreadsinglebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static bool TryReadSingleLittleEndian(ReadOnlySpan<byte>, out float)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.tryreadsinglelittleendian) <sup><sub>.NET 5.0</sub></sup>
  ...
  - [`static bool TryWriteDoubleBigEndian(Span<byte>, double)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.trywritedoublebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static bool TryWriteDoubleLittleEndian(Span<byte>, double)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.trywritedoublelittleendian) <sup><sub>.NET 5.0</sub></sup>
  ...
  - [`static bool TryWriteSingleBigEndian(Span<byte>, float)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.trywritesinglebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static bool TryWriteSingleLittleEndian(Span<byte>, float)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.trywritesinglelittleendian) <sup><sub>.NET 5.0</sub></sup>
  ...
  - [`static double ReadDoubleBigEndian(ReadOnlySpan<byte>)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.readdoublebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static double ReadDoubleLittleEndian(ReadOnlySpan<byte>)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.readdoublelittleendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static float ReadSingleBigEndian(ReadOnlySpan<byte>)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.readsinglebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static float ReadSingleLittleEndian(ReadOnlySpan<byte>)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.readsinglelittleendian) <sup><sub>.NET 5.0</sub></sup>
  ...
  - [`static void WriteDoubleBigEndian(Span<byte>, double)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.writedoublebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static void WriteDoubleLittleEndian(Span<byte>, double)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.writedoublelittleendian) <sup><sub>.NET 5.0</sub></sup>
  ...
  - [`static void WriteSingleBigEndian(Span<byte>, float)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.writesinglebigendian) <sup><sub>.NET 5.0</sub></sup>
  - [`static void WriteSingleLittleEndian(Span<byte>, float)`](https://learn.microsoft.com/dotnet/api/system.buffers.binary.binaryprimitives.writesinglelittleendian) <sup><sub>.NET 5.0</sub></sup>
...
- `RuntimeHelpers`
  ...
  - [`static T[] GetSubArray<T>(T[], Range)`](https://learn.microsoft.com/dotnet/api/system.runtime.compilerservices.runtimehelpers.getsubarray) <sup><sub>.NET Core 3.0</sub></sup>
- `RuntimeInformation`
  ...
  - `static bool IsOSPlatform(OSPlatform)` <sup><sub>.NET Core 1.0</sub></sup>
- `sbyte`
...
- `Stream`
  ...
  - [`ValueTask ReadExactlyAsync(byte[], int, int, CancellationToken)`](https://learn.microsoft.com/dotnet/api/system.io.stream.readexactlyasync#system-io-stream-readexactlyasync(system-byte()-system-int32-system-int32-system-threading-cancellationtoken)) <sup><sub>.NET 7.0</sub></sup>
  - [`ValueTask ReadExactlyAsync(Memory<byte>, CancellationToken)`](https://learn.microsoft.com/dotnet/api/system.io.stream.readexactlyasync#system-io-stream-readexactlyasync(system-memory((system-byte))-system-threading-cancellationtoken)) <sup><sub>.NET 7.0</sub></sup>
  ...
  - [`ValueTask<int> ReadAtLeastAsync(Memory<byte>, int, bool, CancellationToken)`](https://learn.microsoft.com/dotnet/api/system.io.stream.readatleastasync) <sup><sub>.NET 7.0</sub></sup>
