...
public class ConvertTests
{
    ...
    public void FromHexString_String_Test()
    {
        ...
        new Action(() => Convert.FromHexString("4A6F686")).Should().Throw<FormatException>(); // Odd length
        new Action(() => Convert.FromHexString("4A6F68GH")).Should().Throw<FormatException>(); // Invalid character
    }
