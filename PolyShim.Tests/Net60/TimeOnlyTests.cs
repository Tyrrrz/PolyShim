...
public class TimeOnlyTests
{
    ...
    public void Add_Test()
    {
        ...
        // Act & assert
        time.Add(TimeSpan.FromHours(2)).Should().Be(new TimeOnly(15, 45, 0));
        time.AddHours(1.5).Should().Be(new TimeOnly(15, 15, 0));
        time.AddMinutes(30).Should().Be(new TimeOnly(14, 15, 0));
        new TimeOnly(23, 0, 0)
            .Add(TimeSpan.FromHours(2), out var wrappedDays)
            .Should()
            .Be(new TimeOnly(1, 0, 0));
    ...
    public void IsBetween_Test()
    {
        // Act & assert
        new TimeOnly(11, 0, 0)
            .IsBetween(new TimeOnly(10, 0, 0), new TimeOnly(12, 0, 0))
            .Should()
            .BeTrue();
        new TimeOnly(10, 0, 0)
            .IsBetween(new TimeOnly(10, 0, 0), new TimeOnly(12, 0, 0))
        ...
        new TimeOnly(12, 0, 0)
            ...
            .BeFalse();
        new TimeOnly(0, 0, 0)
            .IsBetween(new TimeOnly(23, 0, 0), new TimeOnly(1, 0, 0))
            .Should()
            .BeTrue();
        new TimeOnly(12, 0, 0)
            .IsBetween(new TimeOnly(23, 0, 0), new TimeOnly(1, 0, 0))
    ...
    public void From_Test()
    {
        // Act & assert
        TimeOnly
            .FromDateTime(new DateTime(2023, 5, 17, 13, 45, 30))
            .Should()
            .Be(new TimeOnly(13, 45, 30));
        TimeOnly.FromTimeSpan(new TimeSpan(13, 45, 30)).Should().Be(new TimeOnly(13, 45, 30));
    }
    ...
    public void Equals_Test()
    {
        ...
        (c > a).Should().BeTrue();
        (c >= a).Should().BeTrue();
        (c - a).Should().Be(TimeSpan.FromHours(1));
        (new TimeOnly(1, 0, 0) - new TimeOnly(23, 0, 0)).Should().Be(TimeSpan.FromHours(2));
    }
