...
internal static class MemberPolyfills_Net70_UInt32
{
    extension(uint)
    {
        ...
        // https://learn.microsoft.com/dotnet/api/system.uint32.tryparse#system-uint32-tryparse(system-readonlyspan((system-char))-system-iformatprovider-system-uint32@)
        public static bool TryParse(
            ReadOnlySpan<char> s,
            IFormatProvider? provider,
            out uint result
        ) => uint.TryParse(new string(s.ToArray()), provider, out result);
    }
}
#endif
