    ...
    IComparable
{
    ...
    public static ValueTuple<T1, T2, T3, T4, T5, T6, T7, T8> Create<T1, T2, T3, T4, T5, T6, T7, T8>(T1 item1,
    ...
    IComparable
{
    ...
    public static bool operator <(ValueTuple<T1> left, ValueTuple<T1> right) => left.CompareTo(right) < 0;
    ...
    IComparable
{
    ...
    public static bool operator <(ValueTuple<T1, T2> left, ValueTuple<T1, T2> right) => left.CompareTo(right) < 0;
    ...
    IComparable
{
    ...
    public int CompareTo(object? obj) => obj switch
    {
        ...
        _ => throw new ArgumentException("Object must be of type ValueTuple<T1, T2, T3, T4, T5>")
    };
    ...
    IComparable
{
    ...
    public int CompareTo(object? obj) => obj switch
    {
        ...
        _ => throw new ArgumentException("Object must be of type ValueTuple<T1, T2, T3, T4, T5, T6>")
    };
    ...
    IComparable
{
    ...
    public int CompareTo(object? obj) => obj switch
    {
        ...
        _ => throw new ArgumentException("Object must be of type ValueTuple<T1, T2, T3, T4, T5, T6, T7>")
    };
    ...
    IComparable
{
    ...
    public int CompareTo(object? obj) => obj switch
    {
        ...
        _ => throw new ArgumentException("Object must be of type ValueTuple<T1, T2, T3, T4, T5, T6, T7, TRest>")
    };

    public override int GetHashCode() => HashCode.Combine(Item1, Item2, Item3, Item4, Item5, Item6, Item7, Rest);
